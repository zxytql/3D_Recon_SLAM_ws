...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/elephant/3D_Recon_SLAM_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/elephant/3D_Recon_SLAM_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/elephant/3D_Recon_SLAM_ws/install)
...
if(NOT "/home/elephant/3D_Recon_SLAM_ws/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/elephant/3D_Recon_SLAM_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'elephant <elephant@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/elephant/3D_Recon_SLAM_ws/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/elephant/3D_Recon_SLAM_ws/devel/lib;/home/elephant/zxyros_ws/devel/lib;/home/elephant/myagv_ros/devel/lib;/opt/ros/noetic/lib)
